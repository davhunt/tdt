...
cfg_file = '/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed/TDT_results_run04/res_cfg.mat';
...
parfor i_perm = 1:n_perms
    ...
    cfg_copy.results.filestart = ['perm' sprintf('%04d',i_perm)];
