function [] = gng_permutations_parallel_all_splits_slate_bp_rts_native(subject_num, num_permutations, num_cv_splits)
...
%cfg.files.mask = ['/N/slate/brainevo/Implicit_Learning/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/' subfolder '/mask_ants.nii'];
