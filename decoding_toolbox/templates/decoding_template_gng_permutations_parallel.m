function [] = decoding_template_gng_permutations_parallel(num_permutations, cv_split_number)
...
%cfg_file = '/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed/TDT_results_run4/res_cfg.mat';
cfg_file = ['/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed/TDT_results_run' num2str(cv_split_number, '%.02d') '/res_cfg.mat'];
...
parfor i_perm = 1:n_perms
    cfg_copy = cfg;
    cfg_copy.results.dir = [cfg.results.dir '/' num2str(i_perm, '%.3d')]; % works for 001-999
