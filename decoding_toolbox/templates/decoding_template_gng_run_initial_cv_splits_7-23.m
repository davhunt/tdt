...
%parfor spl = 11:num_cv_splits+10
    ...
    %cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed/TDT_results_run' num2str(spl, '%.2d')];
    cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed/TDT_results2_run' num2str(spl, '%.2d')];
    %cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed/TDT_results_run' num2str(spl, '%.2d') '_flipped1'];
    ...
    cfg.design = make_design_custom_GNG(cfg, stream); % need to seed RNG in function 

    cfg.files.chunk = cfg.design.chunk;
    rmfield(cfg.design,'chunk');

    %%%%%%%%%%%%%%%%%%%%%%%%flip labels
    %cfg.files.label = -cfg.files.label;
    %cfg.design.label = -cfg.design.label;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
