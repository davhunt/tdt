...
% TDT
addpath('/Users/lab/Downloads/tdt_3.999I/decoding_toolbox');
...
cfg.results.dir = '/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed/TDT_results_rep1';
if ~isfolder(cfg.results.dir)
    mkdir(cfg.results.dir)
end

% Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
beta_loc = '/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed';
...
cfg.files.mask = '/Volumes/data1/Complex_seq_analysis/004/MVPA/durations_unsmoothed/mask.nii';
