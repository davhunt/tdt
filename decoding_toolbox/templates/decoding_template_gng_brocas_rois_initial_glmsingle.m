function [] = decoding_template_gng_brocas_rois_initial_glmsingle(subject_num, num_cv_splits, roi_mask_file, roi_name)
...
[filepath,name,ext] = fileparts(roi_mask_file);
...
%parfor spl = 11:num_cv_splits+10
    ...
    %cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/onsets_only_unsmoothed_native/TDT_results/TDT_results_rep' num2str(spl, '%.2d')];
    %cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas/' roi_name '/TDT_results_rep' num2str(spl, '%.2d')];
    cfg.results.dir = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas_glmsingle/' roi_name '/TDT_results_rep' num2str(spl, '%.2d')];
    if ~isfolder(cfg.results.dir)
        mkdir(cfg.results.dir)
    end

    % Set the filepath where your SPM.mat and all related betas are, e.g. 'c:\exp\glm\model_button'
    beta_loc = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/GLMsingle_betas_stimdur2_fracs0.2_pcstop_1'];
    %beta_loc = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native'];
    %beta_loc = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/onsets_only_unsmoothed_native'];
    ...
    cfg.files.mask = roi_mask_file;
    %cfg.files.mask = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/mask.nii'];
    %cfg.files.mask = ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/onsets_only_unsmoothed_native/mask.nii'];
    ...
    %movefile(['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas/' roi_name '/TDT_results_rep' num2str(spl, '%.2d') '/res_accuracy_minus_chance_' name '.nii'], ...
    %  ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas/' roi_name '/TDT_results_rep' num2str(spl, '%.2d') '/res_accuracy_minus_chance.nii']);
    movefile(['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas_glmsingle/' roi_name '/TDT_results_rep' num2str(spl, '%.2d') '/res_accuracy_minus_chance_' name '.nii'], ...
      ['/Volumes/data1/Complex_seq_analysis/' num2str(subject_num, '%.3d') '/MVPA/durations_unsmoothed_native/TDT_results_brocas_glmsingle/' roi_name '/TDT_results_rep' num2str(spl, '%.2d') '/res_accuracy_minus_chance.nii']);
end
delete(gcp('nocreate'))
