...
function p = stats_permutation_test(results_folder, perms_folder, nreps, nperms, tail)
...
save_untouch_nii(out_nii, [results_folder '/pvals_map_post_permutation_test.nii']);